...
from .views import measurement,master,parameter,spc,backup,changed_name,shutdown,report_xlsx,report_pdf,report,measurement_count,comport,login,data,measure_data,delete_measure_data
